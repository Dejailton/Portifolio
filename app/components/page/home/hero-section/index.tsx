        ...
        <section className="w-full lg:h-[755px] bg-hero-image bg-cover bg-center bg-no-repeat flex flex-col justify-end pb-10 sm:pb-32 py-32 lg:pb-[110px]">
            <div className="container flex items-start justify-between flex-col-reverse lg:flex-row">
                <div className="w-full lg:max-w-[500px]">
                    ...
                    <p className="text-blue-400 my-6 text-sm sm:text-base"> Sou um Desenvolvedor de Software Full Stack com experiência em Java, Python, Spring, Node.js, JavaScript e TypeScript. Possuo sólido conhecimento em HTML, CSS, Docker e arquitetura MVC, além de expertise em versionamento com Git/GitHub e gerenciamento de bancos de dados utilizando SQL. Tenho experiência na manutenção e administração de sistemas GNU/Linux e Windows, bem como na implementação de testes unitários com Jest, JUnit e Mockito. Trabalho de forma colaborativa, utilizando metodologias ágeis como Scrum, Kanban e XP para garantir entregas eficientes e de alta qualidade.</p>
